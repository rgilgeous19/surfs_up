#setting up the flask weather app & importing dependencies

import datetime as dt
import numpy as np
import pandas as pd

#importing the dependencies for SQLAlchemy
import sqlalchemy
...
#creating monthly temperature routes    
